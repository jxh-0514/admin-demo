...
HeatCanvas.prototype._render = function (f_value_color) {
	...
	if (!(this.value instanceof Float32Array) || this.width != this._valueWidth || this.height != this._valueHeight) {
...
HeatCanvas.prototype._ensureDefaultPalette = function () {
	if (this._defaultPalette && this._defaultPalette.length == this._paletteSize + 1) return this;
