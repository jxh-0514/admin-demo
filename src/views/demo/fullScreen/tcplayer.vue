  ...
  <div>
    ...
    <div class="play-url-item">
      ...
      <div class="play-btn">
        ...
        <el-button @click="speedBtn">2倍速</el-button>
      </div>
    </div>
  ...
  data() {
    return {
      ...
      options: [
        ...
        // {
        //   value:
        //     "http://192.168.1.71:8080/hdl/34020000001110000002/34020000001310000003/1663126891-1663127257.flv",
        // },
        // {
        //   value:
  ...
  methods: {
    ...
    beforeBtn() {
      ...
      axios({
        ...
        // url: "http://192.168.1.71:8080/gb28181/api/invite?id=34020000001110000002&channel=34020000001310000003&startTime=1663126891&endTime=1663127257",
        url:
