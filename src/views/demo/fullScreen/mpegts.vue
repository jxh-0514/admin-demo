 ...
 * @LastEditors: 杭
 * @LastEditTime: 2024-01-11 23:55:13
-->
<!-- mpegts播放器 -->
<template>
	<div>
		<video id="videoElement" controls autoplay muted width="90%" height="80%"></video>

		<div class="play-url-item">
			<div class="play-url">
				<el-input v-model="inputValue" size="medium" placeholder="请输入播放地址" clearable></el-input>
			</div>
			<div class="play-btn">
				<el-button type="primary" size="medium" @click="playBtn()">播放</el-button>
			</div>
		</div>
	</div>
</template>
