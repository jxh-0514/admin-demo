...
export default {
	...
	created() {
		//输出当前窗口的宽
		this.windowWidth = document.documentElement.clientWidth - 240 || document.body.clientWidth - 240;
		//输出当前窗口的高
		this.windowHeight = document.documentElement.clientHeight - 50 || document.body.clientHeight - 50;
	},
	mounted() {
		// this.init();
		this.initLeaflet();
	...
	methods: {
		...
		initImage() {
			...
			const zoom = lZoom(this.bounds[1][0], this.bounds[1][1], this.windowWidth, this.windowHeight);
