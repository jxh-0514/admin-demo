<template>
	<div class="vue-leaflet-container">
		<l-map id="lmap" ref="map" style="width: 100%; height: 94vh" :zoom="zoom" :center="center">
			<l-tile-layer :url="url" :attribution="attribution" />
			<!-- <v-marker-cluster> -->
			<template v-for="(marker, index) in markers">
				<l-marker :key="index" :icon="defaultIcon" :lat-lng="[marker.lat, marker.lng]" @click="handleMarkerClick(marker)">
...
export default {
	...
	data() {
		return {
			...
			// 优化
			cardTemplate: ['<div style="width: 300px; height: 240px;" id="pane_', '" />'],
			popupOptions: {
				className: "mypopup",
			},
			pane: null,
	...
	methods: {
				...
				let arr = [
					{
						...
						lat: 39.90553,
						lng: 116.391305,
						data: "https://sf1-cdn-tos.huoshanstatic.com/obj/media-fe/xgplayer_doc_video/flv/xgplayer-demo-360p.flv",
					},
					{
						id: 2,
						name: "测试站点2",
						lat: 40.90553,
						lng: 116.393305,
						data: "https://tutorialehtml.com/assets_tutorials/media/Shaun-the-Sheep-The-Movie-Official-Trailer.mp4",
					},
		...
		handleMarkerClick(station) {
			...
			if (!station.data) return this.$message.warning("暂无视频地址");
			if (this.pane != null) {
				console.log("销毁弹窗");
