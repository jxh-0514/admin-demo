<template>
  <div class="home">
    ...
    <el-button class="ml-15" type="primary" @click="onSearchChange"
      >切换</el-button
    >
    <!-- 简易流程图样式 -->
      ...
      <div class="flow-left">
        ...
        <div class="flow-cen">
          ...
          <div class="flow-aa" v-for="(item, i) in abc" :key="i">
            <!-- 审批规则样式 -->
            <div class="gz-aa">{{ i + 1 }}审批规则</div>
            <div class="gz-ab">
              <div class="flow-ab">
                <div
                  class="flow-bb"
                  :style="{
                    height: 300 / item.aa.length - 2 * item.aa.length + 'px',
                  }"
                  v-for="(o, a) in item.aa"
                  :key="a"
                >
                  <div>
                    <!-- {{ o.ab }} -->
              ...
              <!-- 箭头图片 -->
              <div
                style="width: 34px; height: 55px"
                v-show="abc.length - 1 !== i"
              >
                <img
