...
export default {
  data() {
    return {
      ...
      tableData: [
          {code: '1', maxValue: '12', minValue: '5', name: '回家', valueType: '字符', warning: 'ssdf'},
          {code: '2', maxValue: '12', minValue: '5', name: '回家', valueType: '字符', warning: 'ssdf'},
          {code: '3', maxValue: '12', minValue: '5', name: '回家', valueType: '字符', warning: 'ssdf'},
      ],
      isShow: false,
    }
  },
